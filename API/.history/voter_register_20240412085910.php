...
$data = array('username'=>$sms_username, 'password'=>$password, 'sender'=>$sender, 'message'=>$message, 'mobiles'=>$phone);
...
//Recipients
$mail->setFrom($email_website, 'College of Health, Hadejia');
$mail->addAddress($email,$name);     //Add a recipient

$message = "
<html>
<head>
<title>Admission Application |College of Health,  Hadejia</title>
</head>
<body>
<p>Hello <strong>$othernames ,</strong></p>
