...
//save Voter details
$query = "INSERT into `tblcandidate` (voterID,candidateID,maritalstatus,sex,DOB,phone,email,address,lga,state,occupation,status,educational_qualification,photo)
