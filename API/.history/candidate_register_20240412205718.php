...
$voterid = $_POST['txtvoterid'] ?? '1234';
$office = $_POST['cmdoffice']?? 'Governor';
$party = $_POST['cmdparty']?? 'APC';
$status = 1;

date_default_timezone_set('Africa/Lagos');
$current_date = date('Y-m-d');

$sql = "SELECT * FROM tblcandidate where voterid='$voterid'";
...
//Get voter details
$sql_voterid = "select * from tblvoter where voterid='$email'"; 
