...
//save otp
$query = "INSERT into `otpverifications` (voterID,fullname,maritalstatus,sex,DOB,phone,email,address,lga,state,occupation,status,educational_qualification,photo)
VALUES ('$voterID','$fullname','$maritalstatus','$sex',)";
$result = mysqli_query($conn,$query);
