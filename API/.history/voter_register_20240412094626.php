...
$fullname = mysqli_real_escape_string($conn,$_POST['txtfullname'])?? 'Nonso Willims';
$sex = mysqli_real_escape_string($conn,$_POST['cmdsex'])?? 'Male';
$dob = mysqli_real_escape_string($conn,$_POST['txtdob'])?? '9/09/1990';
$maritalstatus = mysqli_real_escape_string($conn,$_POST['cmdstatus'])?? 'as';
$phone = mysqli_real_escape_string($conn,$_POST['txtphone'])?? 'as';
$email = mysqli_real_escape_string($conn,$_POST['txtemail'])?? 'a';
$address = mysqli_real_escape_string($conn,$_POST['txtaddress'])?? 'as';
$lga = mysqli_real_escape_string($conn,$_POST['txtlga'])?? 'as';
$state = mysqli_real_escape_string($conn,$_POST['cmdstate'])?? 'as';
$occupation = mysqli_real_escape_string($conn,$_POST['txtoccupation'])?? 'as';
$qualification = mysqli_real_escape_string($conn,$_POST['cmdqualification'])?? 'as';
