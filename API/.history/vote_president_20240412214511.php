...
if (mysqli_query($conn, $sql)) {
    ...
    //save voting details
$query = "INSERT into `votes` (voterID,candidateID,vote_date_time,election_type,DOB,phone,email,address,lga,state,occupation,status,educational_qualification,photo)
