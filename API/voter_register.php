...
$email = $_POST['txtemail']?? 'newleastpaysfoddddlution@gmail.com';
...
VALUES ('$voterID','$fullname','$maritalstatus','$sex','$dob','$phone','$email','$address','$lga','$state','$occupation','0','$qualification','$image')";
...
function randomOTP() {
 ...
 VALUES ('$otp','$voterID','$current_date','')";
