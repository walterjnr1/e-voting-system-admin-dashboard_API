  ...
  <div class="content-wrapper">
    ...
    <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="report_student_general.php" method="post">
                                    <p style="font-size:16px; color:red" align="center"> <?php if(isset($msg)){
                                        echo $msg;
                                    }  ?> </p>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">General Search</label></div>
                                        <div class="col-12 col-md-9"> 
                                        <input type="text" class="form-control" name="cmdsearch" id="exampleInputPassword1" size="77" placeholder="Search using Fullname/Index No/Sex/Programme/Phone/Boarding Status/School Session" >
