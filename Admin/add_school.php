...
$sql = "SELECT * FROM tblschools where name='$name' ";
 $result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error'] ='School already added';

}else {
  $image= addslashes(file_get_contents($_FILES['avatar']['tmp_name']));
  $image_name= addslashes($_FILES['avatar']['name']);
  $image_size= getimagesize($_FILES['avatar']['tmp_name']);
  move_uploaded_file($_FILES["avatar"]["tmp_name"],"../uploadImage/School/" . $_FILES["avatar"]["name"]);			
  $logo="uploadImage/School/" . $_FILES["avatar"]["name"];

//save Session details
$query = "INSERT into `tblschools` (name,state,phone,logo)
VALUES ('$name','$state','$phone','$logo')";
...
$_SESSION['success'] ='School Added Successfully';
  ...
  $task= $username.' '.'Added New School'.' '. 'On' . ' '.$current_date;
...
$_SESSION['error'] ='Problem adding School';
...
<head>
  ...
  <title>New School|Admin Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
              ...
              <form  action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtstate" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtstate']))?><?php echo $_POST['txtstate']; ?>" placeholder="Enter State">
                  </div>
                  <div class="form-group">
      ...
      <div class="form-group">
                    ...
                    <p class="text-center">
                   <img src="../uploadImage/Profile/default.png" alt="user image" width="178" height="154" id="logo-img">   
				    </p>
              </div>
		   </div>
                <!-- /.card-body -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">School Record(s)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <th width="13%"><div align="center">School Logo</div></th>
                    <th width="13%"><div align="center">School Name</div></th>
                        <th width="13%"><div align="center">State</div></th>
                        <th width="13%"><div align="center">Phone</div></th>
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblschools order by ID desc";
            ...
            <td><div align="center"><?php echo $row['name']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete_school.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                      <a class="dropdown-item" href="edit-school.php?id=<?php echo $row['ID'];?>" >Edit</a>
