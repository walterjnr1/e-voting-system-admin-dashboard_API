...
if(isset($_POST["btnsession"]))
{
 ...
 $sql = "SELECT * FROM school_session where current_session='$session' ";
 $result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error'] ='Session already Open';

}else{
//save Session details
$query = "INSERT into `school_session` (current_session)
VALUES ('$session')";
...
$_SESSION['success'] ='Session Created Successfully';
  ...
  $task= $username.' '.'Open Academic Session'.' '. 'On' . ' '.$current_date;
...
$_SESSION['error'] ='Problem Creating Session';
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Academic Session</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Academic Session</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="form" action="" method="post" class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtsession" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtsession']))?><?php echo $_POST['txtsession']; ?>" placeholder="Enter Session">
                  </div>
     
		   </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" name="btnsession" class="btn btn-primary">Open Session</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Subject Record</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM school_session order by ID";
                                           $result = $conn->query($sql); 
										$cnt=1;
                                           while($row = $result->fetch_assoc()) { ?>
                      <tr class="gradeX">
					  <td height="47"><div align="center"><?php echo $cnt; ?></div></td>
                        <td><div align="center"><?php echo $row['current_session']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete-session.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
