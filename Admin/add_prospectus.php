    ...
    <option>Boarder</option> 
      ...
      <div class="form-group">
            ...
            <div align="left" class="style2">
              <p class="style3"><strong>N/B: Always use the following filename accordingly. </strong></p>
              <p class="style3"><strong>https___cssps.gov_boarder.pdf == Boarders</strong></p>
              <p class="style3"><strong> 
              https___cssps.gov_day.pdf == Day Student </strong></p>
            </div>
