...
$sql = " update tblsubject set name='$subject',subject_type='$type' where ID='$id'";
if (mysqli_query($conn, $sql)) {

//save activity log details
$task= $username.' '.'edited subject data'.' '. 'On' . ' '.$current_date;
             ...
             <form  action="" method="POST" >
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtsubject" id="exampleInputEmail1" size="77" value="<?php echo $row_db['name'];   ?>" placeholder="Enter Subject Name">
                  </div>
            
                  <div class="form-group">
                    <label for="exampleInputEmail1">Subject Type </label>
                    <select name="cmdtype"  id="cmdtype" class="form-control" required>';
             <?php echo '<option value="'.$row_db['subject_type'].'">'.$row_db['subject_type'].'</option>'; ?>
