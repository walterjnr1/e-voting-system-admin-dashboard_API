...
Payment Record
                ...
                <div class="card-body">
                  ...
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tr> <th width="3%"><div align="center">#</div></th>
                        <th width="13%"><div align="center">Reference ID</div></th>
							          <th width="8%"><div align="center">Photo</div></th>
                        <th width="6%"><div align="center">fullname</div></th>
                        <th width="8%"><div align="center">Index No.</div></th>
                       <th width="8%"><div align="center">Phone</div></th>
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM tblstudents INNER JOIN tblpayment ON tblstudents.index_no = tblpayment.index_no order by tblpayment.payment_date desc ";  
               ...
               <td><div align="center">GHS <?php echo number_format((float) $row['amount'] ,2); ?></div></td>
