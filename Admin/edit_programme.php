...
$sql = "select * from tblprogramme where ID='$id'"; 
...
$sql = " update tblprogramme set name='$name' where ID='$id'";
if (mysqli_query($conn, $sql)) {

//save activity log details
$task= $username.' '.'edited Programme data'.' '. 'On' . ' '.$current_date;
             ...
             <form  action="" method="POST" >
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php echo $row_db['name'];   ?>" placeholder="Enter Programme Name">
                  </div>
