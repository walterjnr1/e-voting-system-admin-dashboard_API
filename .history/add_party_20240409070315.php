  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="form-group">
                    ...
                    <p class="text-center">
                   <img src="<?php echo $photo; ?>" alt="user image" width="178" height="154" id="logo-img" style="display: none;"style="display: none;">   
				   
                   <img src="../<?php echo $photo; ?>" alt="" class="avatar-photo" height="100" width="121" id="logo-img" style="display: none;">															      </div>
