...
$query = "SELECT * FROM tblstudents where status='1'"; 
$result = mysqli_query($conn, $query); 
...
if ($result) 
{ 
 $row_schools = mysqli_num_rows($result); 
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Current School Session </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-success elevation-1"><i class="fa fa-home" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Total No. of House(s) </span>
                <span class="info-box-number">
                  <?php  echo $row_houses;   ?>
                  <small></small>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">No. Of Uploaded Student(s) </span>
                <span class="info-box-number">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-secondary elevation-1"><i class="fa fa-graduation-cap" id="icon"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">No. Of Registered Student(s) </span>
                <span class="info-box-number">
                  <?php  echo $row_reg_students;   ?>
                  <small></small>
                </span>
              </div>
              <!-- /.info-box-content -->
...
$sql = "SELECT * FROM tblstudents where status = '1' ORDER BY ID DESC LIMIT 8;";
$result = $conn->query($sql);
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      <li>
                        ...
                        <span class="users-list-date"><?php echo $row_new_students['index_no'];  ?></span>
                      </li>
					   <?php    }  ?>
                    </ul>
