...
//$stmt = $dbh->query("SELECT tblstudents.*, tblclass.name as class_name, tblhouse.name as house_name FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.index_no='$index_no'");
//$row_student= $stmt->fetch();
$sql = "SELECT tblstudents.*, tblclass.name as class_name, tblhouse.name as house_name FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.index_no='$index_no'";
...
<?php
             ...
             echo '<select name="cmdclass"  id="selectSubject" class="form-control" >';
			  echo '<option value="'.$row_student['class'].'">'.$row_student['class_name'].'</option>';
...
<?php
             ...
             echo '<select name="cmdhouse"  id="cmdhouse" class="form-control" required>';
			  echo '<option value="'.$row_student['house'].'">'.$row_student['house'].'</option>';
