...
$stmt = $dbh->query("SELECT tblstudents.*,tblclass.*,tblhouse.* FROM tblstudents INNER JOIN tblclass ON tblsubjectcombination.class = tblclass.ID where index_no='$index_no'");
