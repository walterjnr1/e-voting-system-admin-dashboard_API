...
$stmt = $dbh->query("SELECT tblstudents.*,tblclass.*,tblhouse.* FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblsubject.ID where index_no='$index_no'");
