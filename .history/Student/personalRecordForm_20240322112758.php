...
$stmt = $dbh->query("SELECT tblstudents.*,tblclass.name as class ,tblhouse.name as house FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.index_no='$index_no'");
...
$stmt = $dbh->prepare("SELECT COUNT(class) FROM tblstudents WHERE class = :class and house = :house");
$stmt->bindParam(':class', $class);
$stmt->bindParam(':house', $house);
$stmt->execute();

// Get the number of students and house in the specified class
$numStudents = $stmt->fetchColumn();


//count class in tblstudents
$stmt = $dbh->prepare("SELECT COUNT(class),COUNT(house) FROM tblstudents WHERE class = :class and house = :house");
$stmt->bindParam(':class', $class);
$stmt->bindParam(':house', $house);
$stmt->execute();
