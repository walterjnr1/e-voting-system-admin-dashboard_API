...
$sql="SELECT tblstudents.raw_score as raw_score ,tblstudents.enrollment_code as enrollment_code,tblstudents.jhs_attended as jhs_attended,tblstudents.jhs_type as jhs_type,tblstudents.phone as phone,tblstudents.email as email,tblstudents.fathefather_namer_name as father_name,tblstudents.father_occupation as father_occupation,tblstudents.mother_name as mother_name,tblstudents.mother_occupation as mother_occupation,tblstudents.raw_score, tblclass.name as class_name, tblhouse.name as house_name FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.index_no='$index_no'";
