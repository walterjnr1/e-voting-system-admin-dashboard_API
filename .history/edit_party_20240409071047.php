...
$sql = "select * from tblschools where ID='$id'"; 
...
$sql = " update tblschools set name='$name',state='$state',phone='$phone' where ID='$id'";
if (mysqli_query($conn, $sql)) {

//save activity log details
$task= $username.' '.'Edited school data'.' '. 'On' . ' '.$current_date;
...
<head>
  ...
  <title>Edit School|Admin Dashboard</title>
