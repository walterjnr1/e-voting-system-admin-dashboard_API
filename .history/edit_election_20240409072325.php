...
$sql = "select * from election_type where ID='$id'"; 
...
$sql = " update election_type set name='$name' where ID='$id'";
...
<head>
  ...
  <title>Edit Election Type|Admin Dashboard</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Election Type </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		 ...
		 <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Election Type </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             <form  action="" method="POST" >
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php echo $row_db['name'];   ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">House Limit </label>
                    <input type="number" class="form-control" name="txtlimit" id="exampleInputEmail1" size="77" value="<?php echo $row_db['house_limit'];   ?>">
                  </div>                     
                </div>
                <!-- /.card-body -->
