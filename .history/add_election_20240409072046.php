...
$sql = "SELECT * FROM election_type where name='$name' ";
 $result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error'] ='Election type already added';

}else {
  

//save election type details
$query = "INSERT into `election_type` (name)
VALUES ('$name')";

$result = mysqli_query($conn,$query);
if($result){
        
$_SESSION['success'] ='Election type Added Successfully';

 
}else{
$_SESSION['error'] ='Problem adding Election Type';
...
<head>
  ...
  <title>New Election Type |Admin Dashboard</title>
  ...
  <script type="text/javascript">
		function deldata(){
if(confirm("ARE YOU SURE YOU WISH TO DELETE THIS ELECTION TYPE ?" ))
{
return  true;
}
else {return false;
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add New Election type</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New Election type</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Election type Record(s)</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <table width="106%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                                         <?php 
                                          $sql = "SELECT * FROM election_type order by ID desc";
            ...
            <td><div align="center"><?php echo $row['name']; ?></div></td>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <a class="dropdown-item" href="delete_election.php?id=<?php echo $row['ID'];?>" onClick="return deldata();">Delete</a>
                      <a class="dropdown-item" href="edit_election.php?id=<?php echo $row['ID'];?>" >Edit</a>
