...
$sql = " update tblclass set name='$name',class_limit='$limit' where ID='$id'";
if (mysqli_query($conn, $sql)) {

//save activity log details
$task= $username.' '.'edited Class data'.' '. 'On' . ' '.$current_date;
             ...
             <form  action="" method="POST" >
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php echo $row_db['name'];   ?>" placeholder="Enter Name">
                  </div>
            
                  <div class="form-group">
                    <label for="exampleInputEmail1">Class Limit </label>
                    <input type="number" class="form-control" name="txtlimit" id="exampleInputEmail1" size="77" value="<?php echo $row_db['class_limit'];   ?>" placeholder="Enter Class Limit">
                  </div>
                </div>
                <!-- /.card-body -->
