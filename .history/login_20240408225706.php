...
<title>Login Form | <?php echo $appname;  ?></title>
 <link rel="icon" type="image/png" sizes="16x16" href=<?php echo $appname;  ?>>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b><img src="uploadImage/logo/logo.png" width="124" height="93"><span class="style4"></span></b></a>  </div>
  <!-- /.login-logo -->
  <div class="card">
