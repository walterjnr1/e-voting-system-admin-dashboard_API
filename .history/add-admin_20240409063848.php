...
<html>
<head>
<title>User Account | $appname</title>
</head>
<body>
<p>Hello <strong>$fullname ,</strong></p>
       
<p> Your account as a $group with $appname has been successfully created.</p>
...
$mail->Subject = "User Account  | $appname ";
$mail->Body    = $message;
        ...
        <div class="row">
		 ...
		 <!-- general form elements -->
            <div class="card card-primary">
             ...
             <option value="Resident Electoral Commissioner">Resident Electoral Commissioner</option>
             <option value="Headmaster">Admin</option>
