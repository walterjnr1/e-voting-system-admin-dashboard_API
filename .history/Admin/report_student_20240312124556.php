                ...
                <div class="card-body">
                  <table width="106%" align="center" class="table" id="example1">
                    ...
                    <tbody>
                         ...
                         <tr class="gradeX">
                       <td><?php echo $cnt;  ?></td>
                       <td class="center"><img src="../<?php echo $row['photo'];?>"  width="91" height="73" border="2"/></td>
                        ...
                        <td class="center"><?php echo $row['residential_telephone'];?></td>
