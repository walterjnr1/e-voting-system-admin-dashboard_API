              ...
              <td width="1090" height="184"><div class="card">
                ...
                <div class="card-body">
                  <table width="85%" align="center" class="table table-bordered table-striped" id="example1">
                    ...
                    <tbody>
                                      <?php 
                                          //$sql = "SELECT *,tblclass.name as class,tblhouse.name as house FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID order by tblstudents.ID asc";
                                          //$sql = "SELECT * FROM tblstudents order by ID asc";
