...
$class = strtoupper(mysqli_real_escape_string($conn,$_POST['txtname']));
$house = strtoupper(mysqli_real_escape_string($conn,$_POST['txthouse']));


$sql = " update tblclass set name='$name' where ID='$id'";
