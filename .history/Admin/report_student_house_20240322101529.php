  ...
  <link rel="stylesheet" href="plugins/summernote/summernote-bs4.min.css">
   <script type="text/javascript" src="http://jqueryjs.googlecode.com/files/jquery-1.3.1.min.js"> </script>
    <script type="text/javascript">
        ...
        function Popup(data) {
            var myWindow = window.open('', 'Student Report by House', 'height=400,width=1100');
            myWindow.document.write('<html><head><title>Student Report by House</title>');
            ...
            <tr>
              <td width="1343" height="214"><div class="card">
                <div class="card-header">
                  <p align="center" class="style8">Student Report (<?php echo $current_session;  ?>) <a href="status_report.php"><span class="style12">&lt;&lt; Back</span> </a></p>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table width="97%" align="center" class="table" id="example1">
                    ...
                    <tbody>
                                         <?php
                            //$ret=mysqli_query($conn,"SELECT * FROM tblstudents where status='$query' ORDER BY ID ");
                            $ret=mysqli_query($conn,"SELECT tblstudents.*,tblclass.name as class,tblhouse.name as house FROM tblstudents INNER JOIN tblclass ON tblstudents.class = tblclass.ID INNER JOIN tblhouse ON tblstudents.house = tblhouse.ID where tblstudents.status='$query' order by tblstudents.ID asc");
