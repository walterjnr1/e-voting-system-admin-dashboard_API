...
$sql = " update tblstudents set class='$class',house='$house' where ID='$id'";
if (mysqli_query($conn, $sql)) {

//save activity log details
$task= $username.' '.'Assigned Class and House to Student'.' '. 'On' . ' '.$current_date;
...
header( "refresh:1;url= student_record.php" );
$_SESSION['error']="Class And House Assigned to {$name} successfully"';
}else{
$_SESSION['error']='Problem Assigning class/house to student';
...
<head>
  ...
  <title>Assign House and Class|Admin Dashboard</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Assign House/Class </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
		 ...
		 <!-- general form elements -->
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Assign House/Class  </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
             ...
             echo '<select name="cmdclass"  id="cmdclass" class="form-control" >';
			 			     echo '<option value="'.$row_db['class'].'">'.$row_db['class'].'</option>';
             ...
             $group = $dbh->query($sql);                       
             $group->setFetchMode(PDO::FETCH_ASSOC);
             echo '<select name="cmdhouse"  id="cmdhouse" class="form-control" >';
			 			     echo '<option value="'.$row_db['house'].'">'.$row_db['house'].'</option>';
             while ( $row = $group->fetch() ) 
             {
                echo '<option value="'.$row['name'].'">'.$row['name'].'</option>';
             }
