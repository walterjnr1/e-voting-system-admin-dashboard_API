...
if(isset($_POST['btnexport']))
{
    ...
    $fields = array('SN','Photo','Index No','fullname','sex','Programme','class','Boarding Status','Aggregate','Raw Score','Enrollment Code','JHS Attended','JHS Type','Phone','Email','Father\'s Name','Father\'s Occupation','Mother\'s Name','Mother\'s Occupation','Guardian','Residential Telephone','status','Session','House');
