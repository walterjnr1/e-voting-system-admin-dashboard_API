                            ...
                            <div class="card-body card-block">
                                <form action="report_student.php" method="post">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">From Admission Status</label></div>
                                        <div class="col-12 col-md-9"><input type="date" name="txtfromdate" id="txtsearch" class="form-control" required="true"></div>
                                    </div>
