...
$sql = " update tblstudents set class='$name',house='$house' where ID='$id'";
            ...
            <div class="card card-primary">
             ...
             echo '</select>';
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtname" id="exampleInputEmail1" size="77" value="<?php echo $row_db['name'];   ?>" placeholder="Enter Fullname">
                  </div>
