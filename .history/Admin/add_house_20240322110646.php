...
if(isset($_POST["btnsave"]))
{
 ...
 $limit = strtoupper(mysqli_real_escape_string($conn,$_POST['txtname']));
...
//save house details
$query = "INSERT into `tblhouse` (name)VALUES ('$name')";
              ...
              <form  action="" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtlimit" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtlimit']))?><?php echo $_POST['txtlimit']; ?>" placeholder="Enter House Limit">
                  </div>
		   </div>
                <!-- /.card-body -->
