...
<head>
  ...
  <title> Student Report| <?php echo $email_username ;?> </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="report-investment.php" method="post">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="date" name="txtfromdate" id="fromdate" class="form-control" required="true"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">To Date</label></div>
                                        <div class="col-12 col-md-9"><input type="date" name="txttodate"  class="form-control" required="true"></div>
                                    </div>
