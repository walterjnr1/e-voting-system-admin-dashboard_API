...
header( "refresh:2;url= student_record.php" );
$_SESSION['success']="Class And House Assigned to {$name} successfully";
}else{
$_SESSION['error']="Problem Assigning class/house to {$name}";
