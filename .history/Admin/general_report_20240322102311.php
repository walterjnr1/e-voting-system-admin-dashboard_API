                            ...
                            <div class="card-body card-block">
                                <form action="report_student_status.php" method="post">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <input type="text" class="form-control" name="cmdsearch" id="exampleInputPassword1" size="77" placeholder="Search using Fullname/Index No/Sex/Programme/Phone/Boarding Status" >
