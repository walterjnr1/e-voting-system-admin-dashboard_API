                ...
                <div class="card-body">
                  <table width="97%" align="center" class="table" id="example1">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM tblsubjectcombination INNER JOIN tblclass ON tblsubjectcombination.class = tblclass.ID INNER JOIN tblsubject ON tblsubjectcombination.subject = tblsubject.ID order by tblsubjectcombination.class asc";
