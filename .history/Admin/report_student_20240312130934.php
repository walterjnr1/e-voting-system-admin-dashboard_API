   ...
   <script type="text/javascript" src="http://jqueryjs.googlecode.com/files/jquery-1.3.1.min.js"> </script>
    <script type="text/javascript">
        ...
        function Popup(data) {
            ...
            myWindow.document.write('<html><head><title>my Student Report</title>');
            ...
            <tr>
              <td width="1043" height="214"><div class="card">
                <div class="card-header">
                  <p align="center" class="style8">Student Report (<?php echo $current_session;  ?>)</p>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table width="106%" align="center" class="table" id="example1">
                    <thead>
                    <th><span class="style11">photo</span></th>
						            <th><span class="style11">Index No</span></th>
                        <th><span class="style11">Fullname</span></th>
					             <th><span class="style11">Sex</span></th>
                       <th><span class="style11">Programme</span></th>
                       <th><span class="style11">Class</span></th>
                       <th><span class="style11">Boarding Status</span></th>
						            <th><span class="style11">Aggregate</span></th>
                        <th><span class="style11">Raw score</span></th>
                       <th><span class="style11">Enrollment code</span></th>
					             <th><span class="style11">JHS Attended</span></th>
                       <th><span class="style11">Phone</span></th>
						            <th><span class="style11">Email</span></th>
                        <th><span class="style11">Father's Name</span></th>
                        <th><span class="style11">Father's Occupation</span></th>
                        <th><span class="style11">Guardian</span></th>
                       <th><span class="style11">House</span></th>
				      </tr>
                    </thead>
