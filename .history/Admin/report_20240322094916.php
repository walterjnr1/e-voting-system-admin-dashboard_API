                            ...
                            <div class="card-body card-block">
                                <form action="report_student.php" method="post">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Search by Class/Index No/House/Programme/Fullname/Sex</label></div>
                                        <div class="col-12 col-md-9"> 
                                        <input type="text" class="form-control" name="cmdsearch" id="exampleInputEmail1" size="77" value="" placeholder="">
