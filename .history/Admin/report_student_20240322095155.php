            ...
            <tr>
              <td width="1343" height="214"><div class="card">
                <div class="card-header">
                  <p align="center" class="style8">Student Report (<?php echo $current_session;  ?>) <a href="report.php"><span class="style12">&lt;&lt; Back</span> </a></p>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
