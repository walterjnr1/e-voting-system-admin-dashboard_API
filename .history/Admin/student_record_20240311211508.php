...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <?php } else {?>
    <span class="badge badge-danger">Reject</span>  <?php } ?>
                    ...
                    <div class="dropdown-menu" role="menu">
                      ...
                      <?php if (($row['status'])==(('1')))  { ?>
                      <a class="dropdown-item" href="block-unblock-student.php?id=<?php echo $row['ID'];?>" onClick="return Deactivate('<?php echo $row['fullname']; ?> ');">Reject</a>
					  <?php } else {?>
					  <a class="dropdown-item" href="block-unblock-student.php?uid=<?php echo $row['ID'];?>" onClick="return Activate('<?php echo $row['fullname']; ?> ');">Admit</a>
					  <?php } ?>
