...
$name = strtoupper(mysqli_real_escape_string($conn,$_POST['txtlimit']));


$sql = " update tblhouse set name='$name',house_limit='$limit' where ID='$id'";
if (mysqli_query($conn, $sql)) 
{


  //save activity log details
  $task= $username.' '.'Edited house data'.' '. 'On' . ' '.$current_date;
...
<head>
  ...
  <title>Edit House|Admin Dashboard</title>
