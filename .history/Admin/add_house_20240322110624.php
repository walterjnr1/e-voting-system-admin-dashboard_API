              ...
              <form  action="" method="POST" >
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txtlimit" id="exampleInputEmail1" size="77" value="<?php if (isset($_POST['txtlimit']))?><?php echo $_POST['txtlimit']; ?>" placeholder="Enter House Name">
                  </div>
		   </div>
                <!-- /.card-body -->
