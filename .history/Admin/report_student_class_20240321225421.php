              ...
              <td width="1343" height="214"><div class="card">
                ...
                <div class="card-body">
                  <table width="97%" align="center" class="table" id="example1">
                    ...
                    <tbody>
                                         <?php
                        $ret=mysqli_query($conn,"SELECT * FROM tblstudents where class='$query' ORDER BY ID ");
                        $sql = "SELECT tblstudents.* FROM tblsubjectcombination INNER JOIN tblclass ON tblsubjectcombination.class = tblclass.ID INNER JOIN tblsubject ON tblsubjectcombination.subject = tblsubject.ID order by tblsubjectcombination.class asc";
