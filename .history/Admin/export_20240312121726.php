...
//$searchQuery=$_REQUEST['search']['value'];
  ...
  if (!empty($_REQUEST['search']['value'])) {
    ...
    $f = fopen('php://output', 'w'); // Create a new output stream
     ...
     $fields = array('Index No','fullname','sex','Programme','class','Boarding Status','Aggregate','Raw Score','Enrollment Code','JHS Attended','JHS Type','Phone','Email','Father\'s Name','Father\'s Occupation','Mother\'s Name','Mother\'s Occupation','Guardian','Residential Telephone','Admission Status','Session','House','Action')
